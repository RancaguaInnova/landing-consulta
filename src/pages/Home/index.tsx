...
const Home: React.FC = () => {
  ...
  const handleWindowVoluntario = () => {
    ...
    window.open(
      "https://docs.google.com/forms/d/e/1FAIpQLSfxtp_NtB0_plHIS3DhF0oiC4ZzC2d5b2Vty5LiC1OL5_9fcA/viewform",
      "_blank"
    )
  }
      ...
      try {
        db.ref("/")
          ...
          .on("child_added", function(snapshot) {
            ...
            setRespuestaError("")
            setRespuestaConsulta(
              "Estas habilitado para sufragar en Consulta Ciudadana Municipal Rancagua 2019. Recuerda que puedes sufragar en el local de votación más cercano a su domicilio o lugar de trabajo."
            )
          })
        ...
        if (!habilitado) {
          setRespuestaConsulta("")
          setRespuestaError(
            "No se ha encontrado el rut:" + rutemp + " en el Padrón de servel del 2017."
          )
        }
      } catch (e) {
        setRespuestaConsulta("")
      ...
      <div className="container mt-4 Centro">
          ...
          <div className="Centro">
            ...
            <div className="container mt-4 Centro">
              <Popper
                ...
                open={openPadron}
                anchorEl={anchorElPadron}
                placement={placementPadron}
                transition
                disablePortal={false}
                modifiers={{
                  flip: {
        ...
        <div className="Centro">
          ...
          <p className="Centro">
            ...
            diciembre, de 08:00 a 16:00 horas. Podrán sufragar en el local de votación más cercano a
            ...
            <Fade {...TransitionProps} timeout={350}>
              <Paper className={classes.paper}>
                <Card className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    <Typography className={classes.title} color="textSecondary" gutterBottom>
                      Para mayor información escribenos al{" "}
                      <p>
                        <a href="https://wa.me/56977595314" className="App-link">
                          <FaWhatsapp size={24}></FaWhatsapp> +569 77595314
                        </a>
                      </p>
                    </Typography>
                  </CardContent>
