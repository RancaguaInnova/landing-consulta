...
const Home: React.FC = () => {
  ...
  <h4 className="title">En esta Consulta Ciudadana cada persona tendrá 3 votos a disposición</h4> */}
				...
				<div>
					...
					<p className='Centro'>
						Las vecinas y vecinos de Rancagua podrán ejercer su derecho a voto el día 15 de diciembre, desde
						las 08:00 a 16:00 horas. En los siguientes locales destinados para este proceso:
					</p>
